package com.apl.ticket.widget.circlecustomimage;
...
public class NineGridlayout extends ViewGroup {
    ...
    private void layoutChildrenView() {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            childrenView.setImageUrl(((FoundCircleDetailPostBeen.Image) listData.get(i)).getThumbnailUrl());
    ...
    public void setImagesData(List<FoundCircleDetailPostBeen.Image> images) {
        if (images == null || images.isEmpty()) {
            return;
        }
        //初始化布局
        generateChildrenLayout(images.size());
        //这里做一个重用view的处理
        if (listData == null) {
            int i = 0;
            while (i < images.size()) {
